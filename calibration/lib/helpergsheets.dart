...
// Future<List<List<String>>> fetchDataFromSheet() async {
...
//   String daysUntilNextCalibration,
//   String nextCalibrationDate,
//   String firstAlertDays,
//   String firstAlertDate, // Expect a string here
// ) async {
//   // Initialize GSheets and authenticate
//   final gsheets = GSheets(_credentials);
//   final ss = await gsheets.spreadsheet(_spreadsheetId);
...
//     nextCalibrationDate,
//     firstAlertDays,
//     firstAlertDate, // Pass the string directly
//   ];
